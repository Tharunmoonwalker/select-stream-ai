...
def getllmresponse(query,age_option,tasktype_option):
    ...
    answer=llm.invoke(new_prompt_template.format(template_userInput=query, template_age_option=age_option,template_tasktype_option =tasktype_option))
...
st.header("Hey Mate! how can I help you")
